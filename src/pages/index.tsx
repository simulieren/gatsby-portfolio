        ...
        <Section py={[3, 4, 5]} pt={6}>
          ...
          <Box width={[1, 4 / 5, 2 / 5]}>
            ...
            <P>
              ...
              Doloremque ratione veniam nobis, expedita impedit earum, minima,
              ex quo amet quis assumenda nam. Nesciunt officiis sit aperiam
        ...
        >
          <Box color="#fff" width={[1, 1 / 2]} css={{ zIndex: 1 }}>
            ...
            <P>
              ...
              Webdevelopment unterrichtet. Ich habe zusammen mit anderen
              Dozenten am Curriculum gearbeitet und den Schülern das
              Programmieren beigebracht.
            </P>
            <P>
              Von HTML, CSS und JavaScript bis zu React.js, Node.js und MongoDB
              habe ich die Schüler zum Fullstack JavaScript Developer
              ausgebildet.
            </P>
