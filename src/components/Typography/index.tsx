...
const RightArrowSVG = () => (
  ...
  >
    <g>
      <polygon fill="#231F20" points="8.8,0.4 7.8,1.5 10.5,4.2 0.6,4.2 0.6,5.8 10.5,5.8 7.8,8.5 8.8,9.6 13.4,5 	" />
    </g>
  </svg>
)

const Button: React.ComponentType<{ children?: React.ReactNode; }> = (props) => {
  return (<a  className="button no-arrow-effect do-hover" {...props}>
    {props.children}
