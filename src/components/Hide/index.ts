...
const getMediaBreakpoint = (breakpoints: string[], breakpoint: string, index: number) => {
...
const mediaBreakpoints = breakpoints.reduce((acc: Object, breakpoint: string, index: number) => {
